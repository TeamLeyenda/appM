	...
	<div class="about-main">
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="w3l_header">CONGRESO INTERNACIONAL DE INVESTIGACIÓN
CIENTÍFICA</h3>
				<p>El CONGRESO INTERNACIONAL DE INVESTIGACIÓN CIENTÍFICA 
constituye un escenario idóneo para la interacción entre investigadores, académicos,
estudiantes y profesionales en los ámbitos de la ciencia y la tecnología, y ha sido un
catalizador para el fomento del desarrollo científico-tecnológico de República Dominicana.</p>
			</div>
...
<!--services-section-->
	<div class="services">
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="w3l_header">Charlas <span>--</span></h3>
				<p>You’ll always have fascinating places to be and friendly people to see.</p>
			</div>
			<div class="advantages-grids">
				<div class="col-md-6  col-sm-6 col-xs-6 our-advantages-grid one">
					<div class="up-border">
						...
						<div class="col-md-8 our-advantages-grd-right">
							<h4>OBTENCIÓN DE LA CARBOXIMETILCELULOSA USANDO Lemna COMO MATERIA PRIMA</h4>
...
<div class="clearfix"> </div>
				<div class="col-md-6 col-sm-6 col-xs-6 our-advantages-grid three">
					<div class="up-border">
						...
						<div class="col-md-4 our-advantages-grd-right">
							<h4>PRODUCCIÓN DE ALOÍNA EN VITROPLANTAS POLIPLOIDES DE Aloe vera</h4>
